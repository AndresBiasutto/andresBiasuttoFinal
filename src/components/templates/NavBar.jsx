      ...
      <div className=" z-20 absolute top-0 left-0 px-1 flex flex-row h-full w-full justify-between items-center">
        ...
        >
          <div
            ...
            } transition-all border-2 border-double border-light-text dark:border-dark-text`}
          >
            <div className="h-1 w-5/6 border-2 border-double border-light-text dark:border-dark-text"></div>
            <div className="h-1 w-5/6 border-2 border-double border-light-text dark:border-dark-text"></div>
            <div className="h-1 w-5/6 border-2 border-double border-light-text dark:border-dark-text"></div>
          </div>
        </button>
        <div className="flex flex-row items-center justify-center gap-2">
          <nav
            ...
            } transition-all flex flex-col w-full bg-light-secondary/80 dark:bg-dark-secondary/80 border-b-light-lightBackground dark:border-b-dark-darkBackground  md:static md:flex md:flex-row md:items-center md:justify-center gap-4`}
          >
            <button
              onClick={() => buttonBehavior("inicio")}
              className={`text-light-text dark:text-dark-text px-2  mx-2 bg-light-secondary dark:bg-dark-secondary rounded-md text-2xl`}
            >
              Inicio
            </button>
            <button
